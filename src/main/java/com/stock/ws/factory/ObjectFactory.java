...
public class ObjectFactory {
    ...
    private final static QName REGISTER_ITEM_RESPONSE = new QName("http://stock.ws.com/", "registerItemResponse");
    private final static QName ALL_ITEMS_RESPONSE = new QName("http://stock.ws.com/", "allItemsResponse");
    private final static QName USER_TOKEN = new QName("http://stock.ws.com/", "userToken");
    private final static QName REGISTER_ITEM = new QName("http://stock.ws.com/", "registerItem");
    private final static QName FILTERS = new QName("http://stock.ws.com/", "filters");
    private final static QName FAULT_AUTHORIZATION = new QName("http://stock.ws.com/", "faultAuthorization");
    private final static QName ITEMS_LIST = new QName("http://stock.ws.com/", "itemsList");
    private final static QName ALL_ITEMS = new QName("http://stock.ws.com/", "allItems");
    ...
    @XmlElementDecl(namespace = "http://stock.ws.com/", name = "registerItemResponse")
    ...
    @XmlElementDecl(namespace = "http://stock.ws.com/", name = "allItemsResponse")
    ...
    @XmlElementDecl(namespace = "http://stock.ws.com/", name = "userToken")
    ...
    @XmlElementDecl(namespace = "http://stock.ws.com/", name = "registerItem")
    ...
    @XmlElementDecl(namespace = "http://stock.ws.com/", name = "filters")
    public JAXBElement<Filters> createFilters(final Filters filters) {
        return new JAXBElement<>(FILTERS, Filters.class, null, filters);
    }

    @XmlElementDecl(namespace = "http://stock.ws.com/", name = "faultAuthorization")
    ...
    @XmlElementDecl(namespace = "http://stock.ws.com/", name = "itemsList")
    ...
    @XmlElementDecl(namespace = "http://stock.ws.com/", name = "allItems")
